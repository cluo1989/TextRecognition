...
def parse_args():
    ...
    parser.add_argument('--chars_file', type=str, default='./data/chars/tongyong.txt')
    parser.add_argument('--corpus_dir', type=str, default='/home/cluo/Workspace/ocr/text_renderer/data/corpus/txt_gen')
