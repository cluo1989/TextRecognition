...
def parse_args():
    ...
    parser.add_argument('--config_file', type=str, default='./configs/default0.yaml',
                        help='Set the parameters when rendering images')

    parser.add_argument('--fonts_list', type=str, default='./data/fonts/chn/',
    ...
    parser.add_argument('--corpus_dir', type=str, default="./data/corpus/1",
    ...
    parser.add_argument('--tag', type=str, default='1', help='output images are saved under output_dir/{tag} dir')
